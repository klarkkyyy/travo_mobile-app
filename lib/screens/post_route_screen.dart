...
class _PostRouteScreenState extends State<PostRouteScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final userDoc = await FirebaseFirestore.instance
          ...
          .get();
      final posterName =
          (userDoc.data()?['name'] as String?)?.trim() ?? 'Anonymous';
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Route posted!'),
      ...
      _showError('Failed to post route. Try again.');
    } finally {
  ...
  // These read colorScheme at call-time so they respond to theme changes.
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText:
              'Description (optional) — e.g. Ride from Carbon going to Ayala.',
          hintStyle: TextStyle(
              fontSize: 12,
              color: cs.onSurface.withOpacity(0.4),
              fontFamily: 'Poppins'),
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            Text(
              'Share your personal route experience',
              style: TextStyle(
                  fontSize: 13,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                hintText:
                    'Although the best route is 62C → 04L, this is often traffic and is a hassle',
                hintStyle: TextStyle(
                    fontSize: 13,
                    color: cs.onSurface.withOpacity(0.4),
                    fontFamily: 'Poppins'),
